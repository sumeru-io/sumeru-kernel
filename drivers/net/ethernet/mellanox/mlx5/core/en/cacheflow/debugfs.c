...
static ssize_t mlx5e_cacheflow_rq_tracker_read(struct file *filp,
...
static ssize_t mlx5e_cacheflow_page_pool_stats_read(struct file *filp,
						    char __user *buf,
...
static ssize_t mlx5e_cacheflow_cqe_fifo_len_read(struct file *filp,
						 char __user *buf, size_t count,
						 loff_t *pos)
{
...
static ssize_t mlx5e_cacheflow_cqe_fifo_inserted_read(struct file *filp,
						      char __user *buf,
						      size_t count, loff_t *pos)
{
	struct mlx5e_cacheflow_th *th = filp->private_data;
...
static ssize_t mlx5e_cacheflow_cqe_fifo_missed_read(struct file *filp,
						    char __user *buf,
						    size_t count, loff_t *pos)
{
	struct mlx5e_cacheflow_th *th = filp->private_data;
