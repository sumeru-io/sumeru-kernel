...
static struct ctl_table net_core_table[] = {
	...
	{
		.procname	= "cacheflow_target",
		.data		= &cacheflow_target,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	...
	{
		.procname	= "cacheflow_ack_mod",
		.data		= &cacheflow_ack_mod,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	...
	},
	{
		...
		.data		= &cacheflow_ipi_packet_thresh,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	{
		.procname	= "cacheflow_ipi_usec_thresh",
		.data		= &cacheflow_ipi_usec_thresh,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	{
		.procname	= "cacheflow_elephant_flow_thresh",
		.data		= &cacheflow_elephant_flow_thresh,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	{
		.procname	= "cacheflow_pp_anneal_size",
		.data		= &cacheflow_pp_anneal_size,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	...
	{
		.procname	= "cacheflow_pool_size",
		.data		= &cacheflow_pool_size,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec
	},
	...
	{
		.procname	= "cacheflow_cache_expand_left",
		.data		= &cacheflow_cache_expand_left,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
	...
	{
		.procname	= "cacheflow_cache_boost_factor",
		.data		= &cacheflow_cache_boost_factor,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ONE,
...
# endif
	...
	{
		.procname	= "reuseport_select_sock_round_robin",
		.data		= &net_hotdata.sysctl_reuseport_select_sock_round_robin,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= proc_dointvec_minmax,
		.extra1		= SYSCTL_ZERO,
