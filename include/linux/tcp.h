...
typedef enum enum_tcp_ack_reason {
	...
	ACK_REASON_NORMAL = 1,
	ACK_REASON_QUICKACK = 2,
	ACK_REASON_DUPACK = 3,
	ACK_REASON_SACK_COMPRESSED = 4,
	ACK_REASON_DELAY_EXPIRED = 5,
	ACK_REASON_CHALLENGE_ACK = 6,
	ACK_REASON_PROTOCOL = 8,
	ACK_REASON_DATA_COPIED = 9,
	ACK_REASON_BPF = 10,
	ACK_REASON_DCTCP_BYPASS_TIMER = 11,
	ACK_REASON_DCTCP_CE_CHANGE = 12,
	ACK_REASON_DCTCP_CWR = 13,
